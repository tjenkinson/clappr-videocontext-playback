...
/***/ function(module, exports, __webpack_require__) {
	...
	return _clappr.Playback.VOD;}},{key:'destroy',value:function destroy(){clearInterval(this._updateTimer);this._context.unregisterCallback(this._update);this._context.unregisterCallback(this._onEnded);}},{key:'_onEnded',value:function _onEnded(){this.trigger(_clappr.Events.PLAYBACK_ENDED);this.stop();}},{key:'_update',value:function _update(){var changed=false;if(this._context.duration!==this._lastDurationOnCheck){changed=true;this._lastDurationOnCheck=this._context.duration;}if(this._context.currentTime!==this._lastTimeOnCheck){changed=true;this._lastTimeOnCheck=this._context.currentTime;}changed&&this.trigger(_clappr.Events.PLAYBACK_TIMEUPDATE,{current:this._context.currentTime,total:this._context.duration},this.name);}},{key:'isReady',get:function get(){return true;}},{key:'ended',get:function get(){return this._context.state===_videocontext2.default.STATE.ENDED;}}]);return VideoContextPlayback;}(_clappr.Playback);exports.default=VideoContextPlayback;VideoContextPlayback.canPlay=function(resource){return resource instanceof _videocontext2.default;};module.exports=exports['default'];
